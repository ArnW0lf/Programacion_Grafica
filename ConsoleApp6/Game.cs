...
namespace ConsoleApp6
{
    public class Game : GameWindow
    {
        ...
        {
            CenterWindow(new Vector2i(400, 400));
        }
        ...
        protected override void OnLoad()
        {
            ...
            { 
                ...
                -0.50f,  0.50f,  0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 0: Superior izquierdo frontal - Rojo
                 0.50f,  0.50f,  0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 1: Superior derecho frontal - Rojo
                 0.50f,  0.20f,  0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 2: Inferior derecho frontal - Rojo
                -0.50f,  0.20f,  0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 3: Inferior izquierdo frontal - Rojo

                -0.50f,  0.50f, -0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 4: Superior izquierdo trasero - Rojo
                 0.50f,  0.50f, -0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 5: Superior derecho trasero - Rojo
                 0.50f,  0.20f, -0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 6: Inferior derecho trasero - Rojo
                -0.50f,  0.20f, -0.15f,  1.0f, 0.0f, 0.0f,  // Vértice 7: Inferior izquierdo trasero - Rojo
                
                // Segundo cubo (parte vertical de la T)
                -0.20f,  0.20f,  0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 8: Superior izquierdo frontal - Verde
                 0.20f,  0.20f,  0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 9: Superior derecho frontal - Verde
                 0.20f, -0.60f,  0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 10: Inferior derecho frontal - Verde
                -0.20f, -0.60f,  0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 11: Inferior izquierdo frontal - Verde

                -0.20f,  0.20f, -0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 12: Superior izquierdo trasero - Verde
                 0.20f,  0.20f, -0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 13: Superior derecho trasero - Verde
                 0.20f, -0.60f, -0.15f,  0.0f, 1.0f, 0.0f,  // Vértice 14: Inferior derecho trasero - Verde
                -0.20f, -0.60f, -0.15f,  0.0f, 1.0f, 0.0f    // Vértice 15: Inferior izquierdo trasero - Verde
